node{
    ...
    stage ("Run pyrestfmri container"){
        ...
        -v /home/hadoop/nfs-storage/02-RESULTADOS:/home/elekin/results','python /home/elekin/pyrestfmri/preprocess.py -c /home/elekin/pyrestfmri/conf/config_test.json -p 15')
    }
}