...
La segmentación se orienta con diversos fines. Se puede utilizar tanto como paso previo en el pipeline a la normalización o extracción del cerebro tanto como máscara para facilitar el análisis de una región de interés.
