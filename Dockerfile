...
# 
# Timestamp: 2020/10/25 20:51:21 UTC
...
VOLUME ["/home/elekin/datos:/data/elekin/data/origin/fmri/"]

VOLUME ["/home/elekin/pyrestfmri:/home/spolex/workspaces/elekin/pyrestfmri/"]

VOLUME ["/home/elekin/results:/data/elekin/data/results/preproc-test/"]
...
RUN echo '{ \
    ...
    \n      "volume", \
    \n      [ \
    \n        "/home/elekin/datos:/data/elekin/data/origin/fmri/" \
    \n      ] \
    \n    ], \
    \n    [ \
    \n      "volume", \
    \n      [ \
    \n        "/home/elekin/pyrestfmri:/home/spolex/workspaces/elekin/pyrestfmri/" \
    \n      ] \
    \n    ], \
    \n    [ \
    \n      "volume", \
    \n      [ \
    \n        "/home/elekin/results:/data/elekin/data/results/preproc-test/" \
    \n      ] \
    \n    ] \
    \n  ] \
